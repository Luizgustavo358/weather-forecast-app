...
//  Weather App
//
//  Created by Luiz Gustavo Bragança dos Santos on 26/04/25.
//
...
class ViewController: UIViewController {
    // image constants
    public let bgSky   = UIImage(named: "bgSky")
    public let sunIcon = UIImage(named: "sunIcon")
    
    // color constants
    public let primaryColor  = UIColor(named: "primaryColor")
    public let contrastColor = UIColor(named: "contrastColor")
    
    private lazy var backgroundView: UIImageView = {
        let imageView = UIImageView()
        imageView.image = bgSky
